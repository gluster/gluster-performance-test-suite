...
then
    ...
    echo; echo "eg:"
    echo; echo "    # $0 ./small-file-result.sh ~/config-for-cluster1/BaseLinefuse_and_gnfs_mount_result.txt ~/config-for-cluster1/BaselinePerfTest.log ./results/fuse_and_gnfs_mount_result.txt ./results/PerfTest.log"
    exit
fi
